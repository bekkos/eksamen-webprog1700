...
$("#registrer").click(() => {
    ...
    /* Hent ut alle verdiene fra dokumentet */
    ...
    /* Send til server og håndter eventuelle feilmeldinger som kommer i retur. */
    $.post(url, data, () => {
...
function sjekkPostNr(postNr) {
    let postNummer = postNr;
    const url = "/sjekkPostnr?postnr=" + postNummer;
    $.get(url, (response) => {
        finnes = response;
    });
}
